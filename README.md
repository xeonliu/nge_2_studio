...
Apple Silicon, and macOS Intel. Push a version tag to publish a GitHub Release:
...
Release bundles are unsigned unless the repository is configured with platform
signing credentials.
